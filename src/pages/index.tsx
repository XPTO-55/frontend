...
export default function Home() {
  return (
    <S.PageContainer>
      ...
      <S.Section className="mvv">
        <S.ContainerMvv>
          <S.CardMvv className="missao">
            <div className="mvv-up">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="16"
                height="16"
                fill="currentColor"
                className="bi bi-puzzle-fill svgMissao"
                viewBox="0 0 16 16"
              >
      ...
      <S.Svg2 xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1440 320">
        <path
          fill="#2A8DD2"
          fillOpacity="1"
      ...
      <S.PageContainerFooter>
        <S.ContainerContentFooter>
          <S.ContainerContentFooter className="redesSociais">
            <S.SvgFooter
              xmlns="http://www.w3.org/2000/svg"
              width="16"
              height="16"
          ...
          <S.ContainerContentFooter className="info">
            <h1>Contatos</h1>
            <h2>11 96875-0987</h2>
            <h2>0800 777 2421</h2>
            <h2>grupocpa@cpa.com</h2>
            <h1>Endereço</h1>
            <h2>São Paulo - sp</h2>
            <h2>Rua Hadock lobo, 1234</h2>
          </S.ContainerContentFooter>
        </S.ContainerContentFooter>
        <S.ContainerContentFooter className="suporte">
          <h1>Suporte</h1>
          <h2>FAQ</h2>
